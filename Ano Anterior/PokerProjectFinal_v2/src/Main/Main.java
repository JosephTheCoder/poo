	...
	public static void main(String[] args) throws IOException {
		...
		switch(args[0]){
			case "-i":
				...
				break;
			case "-d":
				if (args.length == 4 && Integer.parseInt(args[1]) > 0){
				...
				break;
			case "-s":
				if (args.length == 4 && Integer.parseInt(args[1]) > 0 && Integer.parseInt(args[2]) < 6 && Integer.parseInt(args[2]) > 0 && Integer.parseInt(args[3]) > 0){
